    ...
    if (mounted) {
      setState(() {
        ...
        _statusMessage = success
            ? '✓ সংযোগ সফল! ড্রাইভার সার্ভার ও ডেটাবেস প্রস্তুত।'
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.settings_ethernet, color: Color(0xFF10B981)),
          ),
          const SizedBox(width: 12),
          const Text('সার্ভার সংযোগ কনফিগ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
        ],
      ),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.link, size: 20, color: Colors.white60),
            ...
            Wrap(
              ...
              children: [
                ActionChip(
                  label: const Text('📡 ওয়াইফাই পিসি', style: TextStyle(fontSize: 11, color: Colors.white)),
                  backgroundColor: const Color(0xFF334155),
                  onPressed: () => _applyPreset(ApiService.defaultLocalUrl),
                ),
                ActionChip(
                  label: const Text('📱 এমুলেটর', style: TextStyle(fontSize: 11, color: Colors.white)),
                  backgroundColor: const Color(0xFF334155),
                  onPressed: () => _applyPreset(ApiService.emulatorUrl),
                ),
                ActionChip(
                  label: const Text('☁️ ক্লাউড', style: TextStyle(fontSize: 11, color: Colors.white)),
                  backgroundColor: const Color(0xFF334155),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: const Text('সংরক্ষণ করুন', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        ),
      ],
    );
  }
